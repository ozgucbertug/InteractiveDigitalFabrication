...
class Robot(object):
	...
	def __init__(self, TP, ptPerLayer=100, printSpeed=25, travelSpeed = 100):
	...
	def push_TP(self):
		...
		# House Keeping Start
		self.robot.queueSpeedTo(100)
		self.robot.queueMoveTo(hoverPt[0], hoverPt[1], hoverPt[2])
		self.robot.queueSpeedTo(250)
		...
		while self.isRunning and not self.isPaused:
